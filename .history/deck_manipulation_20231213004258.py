...
database_path = 'C:\\Users\\Andy\\Documents\\collection.anki2'
...
for id, flds in query:
    ...
    new_back = cleaned_pinyin + cleaned_english
    new_front = cleaned_characters
    print(f"new front: {new_front}, new back: {new_back}")

    
    
    cursor.execute("UPDATE notes SET flds=? WHERE id=? COLLATE unicase", (f"{new_front}\x1f{new_back}", id))
